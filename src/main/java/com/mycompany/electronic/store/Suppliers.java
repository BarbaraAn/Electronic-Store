...
public class Suppliers extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "\t", "Ποιοι προμηθευτές εχουν email που τελειώνει σε gmail.com", "Ποιοι προμηθευτές εχουν το όνομα Γιώργος", "Ποιοι προμηθευτές εχουν site που έχει στο domain name  .gr" }));
    ...
    private void suppliersTableAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_suppliersTableAncestorAdded
        dbconnect.populateTable("select * from supplier", suppliersTable, 1);
